...
--
ALTER TABLE `projects`
  ADD CONSTRAINT `projects_executor_id_foreign` FOREIGN KEY (`executor_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  ADD CONSTRAINT `projects_maintainer_id_foreign` FOREIGN KEY (`maintainer_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE SET NULL;
