...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 08 2024 г., 03:01
...
(31, 6, 'wdwdwdwd', '2024-11-07 20:59:52', '2024-11-07 20:59:52'),
(32, 20, 'sdwq', '2024-11-07 21:00:14', '2024-11-07 21:00:14'),
(33, 1, 'wdq', '2024-11-07 21:00:16', '2024-11-07 21:00:16'),
(34, 10, '123', '2024-11-07 21:00:19', '2024-11-07 21:00:19'),
(35, 18, 'gregf', '2024-11-07 21:00:23', '2024-11-07 21:00:23');
...
(40, '2014_10_12_000000_create_users_table', 3),
(41, '2014_10_12_100000_create_password_reset_tokens_table', 3),
(42, '2019_08_19_000000_create_failed_jobs_table', 3),
(43, '2019_12_14_000001_create_personal_access_tokens_table', 3),
(44, '2024_10_22_185929_create_permission_tables', 3),
(45, '2024_10_23_143222_create_projects_table', 3),
(46, '2024_10_29_083724_create_tasks_table', 3),
(47, '2024_10_31_192501_create_comments_table', 3);
...
(1, 'admin', 'api', '2024-10-24 09:32:33', '2024-10-24 09:32:33'),
(2, 'manager', 'api', '2024-10-24 09:32:37', '2024-10-24 09:32:37'),
(3, 'user', 'api', '2024-10-24 09:32:40', '2024-10-24 09:32:40'),
(4, 'Admin', 'web', '2024-10-27 06:23:14', '2024-10-27 06:23:14'),
(5, 'user', 'web', '2024-10-27 08:20:28', '2024-10-27 08:20:28'),
(6, 'manager', 'web', '2024-10-27 11:14:23', '2024-10-27 11:14:23');
...
(1, 'Денис', 'honorxpremium75@gmail.com', NULL, '$2y$12$CCsO3x3GfrDHFvgITnWDweZgMqTjDkPO8RMIRvRpDON3m2h42/diq', 'bZtuxc1S61y0ASYpNo09y6YS80YONZOBHuGmVd7P8p7OmXPshKzEso3j40lV', '2024-11-01 21:32:31', '2024-11-01 21:32:31'),
(2, 'Максим', 'lakos208@gmail.com', NULL, '$2y$12$JBZdMWF8PrInN/cfDvs/cuKfazBj9ftTRwYN5Q8.D6PSuMwOdOquu', 'YQh0Gj7jItYZKKUYnhD2D2DXDYkYteQpo3AQVYdnUuYv15t6S7iXB1PWYfG3', '2024-11-01 21:32:42', '2024-11-01 21:32:42'),
(3, 'Александр', 'Aleksand@gmail.ru', NULL, '$2y$12$Hz4ToR8QPv0Oao9IsXoBVODGzRNSxEO5v92JzGyOBO7l027gqb11e', '53Lt8i6eER0hUPpa5nCHXhp5UmFEQj1ZfcQ5GKPhAFBFw8zzX1OCTNLly7Gl', '2024-11-01 21:32:52', '2024-11-01 21:32:52'),
(4, 'Никита', 'den.karpov471@gmail.com', NULL, '$2y$12$Lx175NhdQW9lJbum0GaJzOGEFZQCpibt4e9kflCy2Fz6CWXFzB7jS', 'r7KIUHQMuPIwM3cUr3EIVdl1m1ODrVvLPYgahvSjV1ITHkHchOmXKbYww45V', '2024-11-01 21:33:06', '2024-11-01 21:33:06'),
(5, 'Олег', 'subscribe@mail.ru', NULL, '$2y$12$wyD5q/HmcZfGj8pEvPB9f.IJmjo9hfHdcOio3GW7dnVZy2yjIkmki', '1teBa8sN6rvjs1MARK64Ltol7qoFylnokvl9JDpLZsmfFUtYFhPc7Ji7qeGF', '2024-11-01 21:33:24', '2024-11-01 21:33:24');
...
--
ALTER TABLE `projects`
  ADD CONSTRAINT `projects_ibfk_1` FOREIGN KEY (`maintainer_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  ADD CONSTRAINT `projects_ibfk_2` FOREIGN KEY (`executor_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE SET NULL;
